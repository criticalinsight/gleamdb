...
pub fn ebbinghaus_with_floor(days_since_access: Float, stability: Float, floor: Float) -> Float {
...
pub fn compute_stability(access_count: Int, avg_days_between_accesses: Float) -> Float {
...
pub fn hebbian_update(current_weight: Float, effective_signal: Float) -> Float {
  ...
  let log_new = log(clamped_current) +. effective_signal *. log(1.0 +. hebbian_learning_rate)
